...
// });
$routes->get('/', 'Home::index');
$routes->get('/pemain', 'Admin::pemain');
$routes->get('/team', 'Admin::team');

$routes->get('/createPemain', 'Admin::createPemain');
$routes->post('/storePemain', 'Admin::storePemain');
$routes->get('/editPemain/(:num)', 'Admin::editPemain/$1');
$routes->post('/updatePemain/(:num)', 'Admin::updatePemain/$1');
$routes->get('/deletePemain/(:num)', 'Admin::deletePemain/$1');

$routes->get('/createteam', 'Admin::createTeam');
$routes->post('/storeTeam', 'Admin::storeTeam');
$routes->get('/editTeam/(:num)', 'Admin::editTeam/$1');
$routes->post('/updateTeam/(:num)', 'Admin::updateTeam/$1');
$routes->get('/deleteTeam/(:num)', 'Admin::deleteTeam/$1');
/*
 * --------------------------------------------------------------------
 * Additional Routing
 * --------------------------------------------------------------------
